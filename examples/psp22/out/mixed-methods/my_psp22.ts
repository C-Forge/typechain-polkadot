...
export default class Methods {
   ...
   * @returns { void }
   */
  transfer(to: ArgumentTypes.AccountId, value: string | number | BN, data: Array<number | string | BN>, __options: GasLimit) {
   ...
   * @returns { void }
   */
  decreaseAllowance(spender: ArgumentTypes.AccountId, deltaValue: string | number | BN, __options: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   * @returns { ReturnNumber }
   */
  allowance(owner: ArgumentTypes.AccountId, spender: ArgumentTypes.AccountId, __options: GasLimit): Promise<QueryReturnType<ReturnNumber>> {
    return queryJSON<ReturnNumber>(
      this.__apiPromise,
      this.__nativeContract,
      this.__callerAddress,
   ...
   * @returns { void }
   */
  increaseAllowance(spender: ArgumentTypes.AccountId, deltaValue: string | number | BN, __options: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
  ...
  totalSupply(__options: GasLimit): Promise<QueryReturnType<ReturnNumber>> {
    return queryJSON<ReturnNumber>(this.__apiPromise, this.__nativeContract, this.__callerAddress, 'psp22::totalSupply', [], __options, (result) => {
      return new ReturnNumber(result as number | string);
    });
  }
   ...
   * @returns { void }
   */
  approve(spender: ArgumentTypes.AccountId, value: string | number | BN, __options: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   * @returns { void }
   */
  mint(account: ArgumentTypes.AccountId, amount: string | number | BN, __options: GasLimit) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
