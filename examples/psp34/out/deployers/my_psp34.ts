...
import MyPsp34 from '../contracts/my_psp34';
...
const fileName = 'my_psp34';

export default class MyPsp34Deployer {
  ...
  async new(__options?: ContractOptions) {
    ...
    const contractObj = getContractObjectWrapper(this.nativeAPI, MyPsp34, address, this.signer);
    return {
