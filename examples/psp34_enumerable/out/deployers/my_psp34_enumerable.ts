...
import MyPsp34Enumerable from '../contracts/my_psp34_enumerable';
...
const fileName = 'my_psp34_enumerable';

export default class MyPsp34EnumerableDeployer {
  ...
  async new(__options?: ContractOptions) {
    ...
    const contractObj = getContractObjectWrapper(this.nativeAPI, MyPsp34Enumerable, address, this.signer);
    return {
