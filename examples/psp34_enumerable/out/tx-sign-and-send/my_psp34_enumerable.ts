...
export default class MyPsp34EnumerableMethods {
   ...
   * @param { ArgumentTypes.Id } id,
   */
  burn(account: ArgumentTypes.AccountId, id: ArgumentTypes.Id, contractOptions?: ContractOptions, signerOptions?: Partial<SignerOptions>) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
   ...
   */
  tokenByIndex(index: string | number | BN, contractOptions?: ContractOptions, signerOptions?: Partial<SignerOptions>) {
    return txSignAndSend(
      this.__apiPromise,
      this.__nativeContract,
      this.__keyringPair,
