...
import type { GasLimitAndValue, RequestArgumentType } from './types';
...
export declare function txSignAndSend(
...
export declare function buildSubmittableExtrinsic(
  api: ApiPromise,
  nativeContract: ContractPromise,
  title: string,
  args?: readonly RequestArgumentType[],
  gasLimitAndValue?: GasLimitAndValue,
): SubmittableExtrinsic<'promise', import('@polkadot/types/types').ISubmittableResult>;
/**
 * (i) For reference, see:
 ...
 */
export declare function _signAndSend(
  registry: Registry,
