...
```bash
npx @c-forge/typechain-polkadot --input path/to/abis --output path/to/output
```
...
```bash
npx @c-forge/typechain-polkadot --input path/to/abis --output path/to/output --plugins ./plugins-directory
```
